    ...
    <section style={section}>
      <div style={inner}>
        <div style={head}>
          ...
          <h2 style={title}>
            <span style={accent}>AI&rsquo;m Scan</span>?�로 �?곳을 먼�? 찾는??
          </h2>
          <p style={lead}>
            방향·?�략·구조·?�익?�·프롬프?�·디?�인·?�사결정 ??7�??�역??21문항?�로 진단?�다.
            결과??5?�계 ?�벨�??�한 ?�역 TOP 3?�로 ?�리?�다.
          </p>
          <div style={stats}>
            <div style={statItem}>
              <span style={statValue}>7</span>
              <span style={statLabel}>?�역</span>
            </div>
            <div style={statItem}>
